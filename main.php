...
">
			...
			<div class="row">
				<div class="col s9">
          		<input placeholder="What you Love..." id="myInput1" type="text" class="input">
          		</div>
	...
	<div class="col s3" style="background-color: #a7ffeb ; padding: 10px;border:1px solid white;">
		...
		<div class="row">
				<div class="col s9">
          		<input placeholder="What you are Good at..." id="myInput2" type="text" class="input">
          		</div>
	...
	<div class="col s3" style="background-color: #a7ffeb ;padding: 10px;border:1px solid white;">
		...
		<div class="row">
				...
				<div class="col s9">
          		<input placeholder="What you can be Paid for.." id="myInput3" type="text" class="input">
          		</div>
	...
	<div class="col s3" style="background-color: #a7ffeb ;padding: 10px;border:1px solid white;">
		<div class="row">
				<div class="col s9">
          		<input placeholder="What the World needs..." id="myInput4" type="text" class="input">
          		</div>
